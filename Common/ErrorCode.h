...
namespace NCommon
{
	...
	enum class ERROR_CODE : short
	{
		...
		ServerHost_INIT_NETWORK_INIT_FAIL = 206,
		...
		LOBBY_LIST_INVALID_DOServerHost = 226,

		LOBBY_ENTER_INVALID_DOServerHost = 231,
